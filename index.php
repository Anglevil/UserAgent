...
function get_useragent($ua){
	...
	$os = get_os($ua);
	echo '<img src="'.$url.$os[1].'.png" title="'.$os[0].'" style="border:0px;vertical-align:middle;margin-right:2px" alt="'.$os[0].'"><img src="'.$url.$browser[1].'.png" title="'.$browser[0].'" style="border:0px;vertical-align:middle;" alt="'.$browser[0].'">';
}
